...
BEGIN
  ...
  |                     => OCI Functions                                                                            |
  |                     https://github.com/jganggini/oci-functions/blob/main/oci-serviceconnector-streaming-dml-adb-in-python/_query_adb/03-UTILITY/101-table-utl_log_streaming.sql
  ...
  |-----------------------|----------------------|------------------------------------------------------------------|
  | UTILITY               | UTL                  | sp_load_data_from_streaming                                      |
  `-----------------------------------------------------------------------------------------------------------------|
                                                                                                                    |
  --[UTL_LOG_LOAD_DATA_FROM_ADB_TO_OCI_STREAMING]------------------------------------------------------------------*/
    BEGIN                                                                                                         --|
        INSERT INTO UTL_LOG_STREAMING (UTL_LOG_KEY,                                                               --|
                                       UTL_LOG_VALUE,                                                             --|
                                       UTL_LOG_DML,                                                               --|
                                       UTL_LOG_OFFSET)                                                            --|
                               VALUES (par_key,                                                                   --|
  ...
  --[DELETE:STG_LICENCIAS_MEDICAS]---------------------------------------------------------------------------------*/
    BEGIN                                                                                                         --|
      ...
      AS jt                                                                                                       --|
      WHERE utl.utl_log_offset = par_offset);                                                                     --|
                                                                                                                  --|
      COMMIT;                                                                                                     --|
                                                                                                                  --|
    EXCEPTION                                                                                                     --|
